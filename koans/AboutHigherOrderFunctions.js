...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'all' to test whether all items pass condition", function () {
    ...
    expect(_(onlyEven).all(isEven)).toBe(true); // only has one true value applied to the entire string/evaluation
    expect(_(mixedBag).all(isEven)).toBe(false); // only has one false value applied to the entire string/evaluation
  });
